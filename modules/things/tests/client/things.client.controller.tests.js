  ...
  describe('Things Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleThingPostData = new ThingsService({
          name: 'Thing Name'
        });

        $scope.vm.thing = sampleThingPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ThingsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('things.view', {
          thingId: mockThing._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        // Mock Thing in $scope
        $scope.vm.thing = mockThing;
      });

      it('should update a valid Thing', inject(function (ThingsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (ThingsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Thing and redirect to Things', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('things.list');
      });

      it('should should not delete the Thing and not redirect', function () {
