 ...
 * Thing Schema
 */
var ThingsDataSchema = new Schema({
  thingsId: {
...
ThingsDataSchema.statics.getLastData = function (thingId) {
...
ThingsDataSchema.statics.getData = function (thingId, startDate, endDate) {
  var ThingsData = mongoose.model('ThingsData');
  return new Promise(function (resolve, reject) {
    var q = {};
...
mongoose.model('ThingsData', ThingsDataSchema);
