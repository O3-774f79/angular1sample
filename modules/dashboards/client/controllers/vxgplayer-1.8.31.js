/*eslint-disable */
angular.module('dashboards').controller('vxgCtrl', function ($state, $window, $http, $scope) {
...
window.vxgplayer.initOptions = function(self, options){
	...
	var nmf_src = "https://cdn.jsdelivr.net/npm/vxgplayer@1.8.31/pnacl/Release/media_player.nmf";
