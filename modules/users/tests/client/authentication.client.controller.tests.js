    ...
    describe('Logged out user', function () {
      ...
      describe('$scope.signin()', function () {
        ...
        it('should fail to log in with nothing', function () {
          ...
          expect(Notification.error).toHaveBeenCalledWith({ message: 'Missing credentials', title: '<i class="ic-close"></i> Signin Error!', delay: 6000 });
        });
        ...
        it('should fail to log in with wrong credentials', function () {
          ...
          // Test Notification.error is called
          expect(Notification.error).toHaveBeenCalledWith({ message: 'Unknown user', title: '<i class="ic-close"></i> Signin Error!', delay: 6000 });
        });
      });
      ...
      describe('$scope.signup()', function () {
        ...
        it('should fail to register with duplicate Username', function () {
          ...
          // Test Notification.error is called
          expect(Notification.error).toHaveBeenCalledWith({ message: 'Username already exists', title: '<i class="ic-close"></i> Signup Error!', delay: 6000 });
        });
      });
    });
