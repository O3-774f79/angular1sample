(function () {
  ...
  angular
        .module('users')
        .controller('MylabDocumentController', MylabDocumentController);

  MylabDocumentController.$inject = ['$document', '$scope', '$stateParams', 'UsersService', '$location', 'Authentication'];

  function MylabDocumentController($document, $scope, $stateParams, UsersService, $location, Authentication) {
    var vm = this;
    ...
    // display nav top
      ...
      window.location.href = '/userguide-platform';
    }
