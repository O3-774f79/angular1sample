      ...
      if (req.body.username) {
        User.findOne({
          ...
          if (err || !user) {
            ...
            // });
            return res.json({ user: false, message: 'No account with that username has been found' });

          } else if (user.provider !== 'local') {
            // return res.status(400).send({
            //   message: 'It seems like you signed up using your ' + user.provider + ' account'
            // });
            return res.json({ user: 'local', message: 'It seems like you signed up using your ' + user.provider + ' account' });
          } else {
